<script>
  ...
  // these are hard coded to 0, 25, 50, 75 and 100%
...
<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" version="1.1" viewBox="0 0 24 24" {style} {id} class={classes}>
  <path {fill} {d}/>
</svg>
